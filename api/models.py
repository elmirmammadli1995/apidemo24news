...
news5 = News(
 ...
 news6 = News(
    "Here are the best iPad deals you can get",
...
news7 = News(
    ...
    "Verizon is announcing a new price lock policy today, and the timing is probably no coincidence. The company is extending a three-year price guarantee on certain plans, both for new and existing customers. The announcement comes a day after President Trump unveiled sweeping tariffs, and Verizon says it’s hoping to give customers more “predictability” in the current economic environment.",
    "https://picsum.photos/800?random=7"
)

news8 = News(
    "Amazon is ready to launch its Starlink competitor",
    "The first batch of 27 Project Kuiper space internet satellites are scheduled to launch next week. Amazon has secured 80 such launch missions that will each deliver dozens of satellites into low earth orbit (LEO) to create a constellation capable of competing with Elon Musk’s Starlink juggernaut.",
...
news11 = News(
    ...
    ""TikTok is shutting down Notes, its photos-sharing app that rivaled Instagram. In a notification to users, the TikTok Notes team says the app will stop working starting May 8 th, “all related features will no longer be available.”,
...
news22 = News(
    ...
    "From the Kindle Colorsoft and Samsung’s new Galaxy S25 to the top-of-the-line Roborock S8 MaxV Ultra, Amazon’s Big Spring Sale has brought steep discounts on some of our favorite gadgets.",
