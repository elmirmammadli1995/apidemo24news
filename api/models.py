...
news3 = News(
    ...
    "Honda is looking to the stars for its next hydrogen breakthrough. The automaker is teaming up with space tech companies Sierra Space and Tec-Masters to test its high-differential pressure water electrolysis system on the International Space Station.",
...
news9 = News(
    ...
    "French satellite network company Eutelsat has been providing Ukraine with much-needed internet access for almost a year with the help of the German government, Reuters reports.",
...
news12 = News(
    ...
    "Fiber internet providers are worried they won’t see the funds promised under a Biden-era initiative that would bring reliable internet service to rural areas.",
...
news20 = News(
    ...
    "India's longest and most holy river, the Ganges, is home to thousands of dolphins. But their survival is under threat. But these aren't like the ones found in oceans. They don't leap out of the water in spectacular arcs; surface for long intervals or swim in an upright position.",
    "https://picsum.photos/800?random=20"
)

news21 = News(
    "FromSoftware’s Miyazaki assures fans the studio will still make single-player games",
    "In a multi-part interview with Nintendo about newly-announced Switch 2 exclusive The Duskbloods, director Hidetaka Miyazaki tried to dispel worries that developer FromSoftware is shifting focus away from single-player games.",
...
news24 = News(
    ...
    "It’s hard to buy a bad pair of wireless earbuds these days, and with constant discounts and deals wherever you look, now is as good of a time as any to splurge on the pair you’ve been eyeing.",
